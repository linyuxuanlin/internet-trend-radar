...
const DATA_CONTRACT = {
  ...
  source_scope: 'Worker/D1 declared runtime scope: COLLECTOR_SOURCES plus Hacker News and GitHub; the xiaohongshu external Bridge is disabled; actual scoring still requires enabled, fresh source status and current raw evidence, while static-only Pages adapters are excluded'
};
